...
public class DevicesettingsEntity implements java.io.Serializable {
    /** 版本号 */
    ...
    /** mValue */
    @Column(name = "M_VALUE", nullable = true, length = 10)
    private Integer mValue;

    /** intervalT */
    @Column(name = "INTERVAL_T", nullable = true, length = 10)
    ...
    /** ch1Base */
    @Column(name = "CH1_BASE", nullable = true, length = 10)
    private Integer ch1Base;

    /** ch1Db */
    @Column(name = "CH1_DB", nullable = true, length = 10)
    private Integer ch1Db;

    /** ch1Threshold */
    @Column(name = "CH1_THRESHOLD", nullable = true, length = 10)
    private Integer ch1Threshold;

    /** ch1Delay */
    @Column(name = "CH1_DELAY", nullable = true, length = 10)
    private Integer ch1Delay;

    /** ch1Sensor */
    @Column(name = "CH1_SENSOR", nullable = true)
    private Float ch1Sensor;

    /** ch2Base */
    @Column(name = "CH2_BASE", nullable = true, length = 10)
    private Integer ch2Base;

    /** ch2Db */
    @Column(name = "CH2_DB", nullable = true, length = 10)
    private Integer ch2Db;

    /** ch2Threshold */
    @Column(name = "CH2_THRESHOLD", nullable = true, length = 10)
    private Integer ch2Threshold;

    /** ch2Delay */
    @Column(name = "CH2_DELAY", nullable = true, length = 10)
    private Integer ch2Delay;

    /** ch2Sensor */
    @Column(name = "CH2_SENSOR", nullable = true)
    private Float ch2Sensor;

    /** ch1AlarmAmplitude */
    @Column(name = "CH1_ALARM_AMPLITUDE", nullable = true, length = 10)
    private Integer ch1AlarmAmplitude;

    /** ch1AlarmFrequency */
    @Column(name = "CH1_ALARM_FREQUENCY", nullable = true, length = 10)
    private Integer ch1AlarmFrequency;

    /** ch2AlarmFrequency */
    @Column(name = "CH2_ALARM_FREQUENCY", nullable = true, length = 10)
    private Integer ch2AlarmFrequency;

    /** ch2AlarmAmplitude */
    @Column(name = "CH2_ALARM_AMPLITUDE", nullable = true, length = 10)
    ...
    /** initiativeStatus */
    @Column(name = "INITIATIVE_STATUS", nullable = true, length = 10)
    private Integer initiativeStatus;

    /** amplitudeDebug */
    @Column(name = "AMPLITUDE_DEBUG", nullable = true, length = 10)
    private Integer amplitudeDebug;

    /** ch1DischargeDifference */
    @Column(name = "CH1_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch1DischargeDifference;

    /** ch2DischargeDifference */
    @Column(name = "CH2_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch2DischargeDifference;

    /** ch3DischargeDifference */
    @Column(name = "CH3_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch3DischargeDifference;

    /** ch4DischargeDifference */
    @Column(name = "CH4_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch4DischargeDifference;

    /** ch5DischargeDifference */
    @Column(name = "CH5_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch5DischargeDifference;

    /** ch6DischargeDifference */
    @Column(name = "CH6_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch6DischargeDifference;

    /** ch7DischargeDifference */
    @Column(name = "CH7_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch7DischargeDifference;

    /** ch8DischargeDifference */
    @Column(name = "CH8_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch8DischargeDifference;

    /** deviceSerialNumber */
    @Column(name = "DEVICE_SERIAL_NUMBER", nullable = true, length = 10)
    ...
    /** ch1Addbase */
    @Column(name = "CH1_ADDBASE", nullable = true, length = 10)
    private Integer ch1Addbase;

    /** ch2Addbase */
    @Column(name = "CH2_ADDBASE", nullable = true, length = 10)
    private Integer ch2Addbase;

    /** baudrate */
    @Column(name = "BAUDRATE", nullable = true, length = 10)
    private Integer baudrate;

    /** noiseSwitch */
    @Column(name = "NOISE_SWITCH", nullable = true, length = 10)
    private Integer noiseSwitch;

    /** temwarnvalue */
    @Column(name = "TEMWARNVALUE", nullable = true, length = 10)
    private Integer temwarnvalue;

    /** temcriticalvalue */
    @Column(name = "TEMCRITICALVALUE", nullable = true, length = 10)
    private Integer temcriticalvalue;

    /** ch1DischargeDifferenceB */
    @Column(name = "CH1_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch1DischargeDifferenceB;

    /** ch2DischargeDifferenceB */
    @Column(name = "CH2_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch2DischargeDifferenceB;

    /** ch3DischargeDifferenceB */
    @Column(name = "CH3_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch3DischargeDifferenceB;

    /** ch4DischargeDifferenceB */
    @Column(name = "CH4_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch4DischargeDifferenceB;

    /** ch5DischargeDifferenceB */
    @Column(name = "CH5_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch5DischargeDifferenceB;

    /** ch6DischargeDifferenceB */
    @Column(name = "CH6_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch6DischargeDifferenceB;

    /** ch7DischargeDifferenceB */
    @Column(name = "CH7_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch7DischargeDifferenceB;

    /** ch8DischargeDifferenceB */
    @Column(name = "CH8_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch8DischargeDifferenceB;

    /** oppositeRange */
    @Column(name = "oppositeRange", nullable = true, length = 10)
    private Integer oppositeRange;

    /** ch3Base */
    @Column(name = "CH3_BASE", nullable = true, length = 10)
    private Integer ch3Base;

    /** ch3Db */
    @Column(name = "CH3_DB", nullable = true, length = 10)
    private Integer ch3Db;

    /** ch3Threshold */
    @Column(name = "CH3_THRESHOLD", nullable = true, length = 10)
    private Integer ch3Threshold;

    /** ch3Delay */
    @Column(name = "CH3_DELAY", nullable = true, length = 10)
    private Integer ch3Delay;

    /** ch3Sensor */
    @Column(name = "CH3_SENSOR", nullable = true)
    private Float ch3Sensor;

    /** ch3Difference */
    @Column(name = "CH3_DIFFERENCE", nullable = true, length = 10)
    private Integer ch3Difference;

    /** ch3Addbase */
    @Column(name = "CH3_ADDBASE", nullable = true, length = 10)
    private Integer ch3Addbase;

    /** ch1UhfDischargeDifference */
    @Column(name = "CH1_UHF_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch1UhfDischargeDifference;

    /** ch2UhfDischargeDifference */
    @Column(name = "CH2_UHF_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch2UhfDischargeDifference;

    /** ch3UhfDischargeDifference */
    @Column(name = "CH3_UHF_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch3UhfDischargeDifference;

    /** ch4UhfDischargeDifference */
    @Column(name = "CH4_UHF_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch4UhfDischargeDifference;

    /** ch5UhfDischargeDifference */
    @Column(name = "CH5_UHF_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch5UhfDischargeDifference;

    /** ch6UhfDischargeDifference */
    @Column(name = "CH6_UHF_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch6UhfDischargeDifference;

    /** ch7UhfDischargeDifference */
    @Column(name = "CH7_UHF_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch7UhfDischargeDifference;

    /** ch8UhfDischargeDifference */
    @Column(name = "CH8_UHF_DISCHARGE_DIFFERENCE", nullable = true, length = 10)
    private Integer ch8UhfDischargeDifference;

    /** ch1UhfDischargeDifferenceB */
    @Column(name = "CH1_UHF_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch1UhfDischargeDifferenceB;

    /** ch2UhfDischargeDifferenceB */
    @Column(name = "CH2_UHF_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch2UhfDischargeDifferenceB;

    /** ch3UhfDischargeDifferenceB */
    @Column(name = "CH3_UHF_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch3UhfDischargeDifferenceB;

    /** ch4UhfDischargeDifferenceB */
    @Column(name = "CH4_UHF_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch4UhfDischargeDifferenceB;

    /** ch5UhfDischargeDifferenceB */
    @Column(name = "CH5_UHF_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch5UhfDischargeDifferenceB;

    /** ch6UhfDischargeDifferenceB */
    @Column(name = "CH6_UHF_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch6UhfDischargeDifferenceB;

    /** ch7UhfDischargeDifferenceB */
    @Column(name = "CH7_UHF_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch7UhfDischargeDifferenceB;

    /** ch8UhfDischargeDifferenceB */
    @Column(name = "CH8_UHF_DISCHARGE_DIFFERENCE_B", nullable = true, length = 10)
    private Integer ch8UhfDischargeDifferenceB;

    /** uhfRangeSet */
    @Column(name = "UHF_RANGE_SET", nullable = true, length = 10)
    private Integer uhfRangeSet;

    /** noiseUhfSwitch */
    @Column(name = "NOISE_UHF_SWITCH", nullable = true, length = 10)
